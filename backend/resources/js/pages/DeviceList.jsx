    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap gap-4 items-center">
          ...
          >
            <option value="all">{t('common.all') || 'All Owners'}</option>
          ...
          <select
            ...
            className="bg-white rounded-xl px-4 py-3 text-sm shadow-sm focus:ring-2 focus:ring-[#06402b]/10 cursor-pointer"
          >
            <option value="all">{t('common.all') || 'All Battery'}</option>
          ...
          <select
            ...
            className="bg-white rounded-xl px-4 py-3 text-sm shadow-sm focus:ring-2 focus:ring-[#06402b]/10 cursor-pointer"
          >
            <option value="all">{t('common.all') || 'All Assignments'}</option>
      ...
      {filteredDevices.length === 0 ? (
        <div className="p-12 text-center bg-white rounded-3xl shadow-sm border border-[#c0c9c1]/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredDevices.map((device) => {
            ...
            const assignedAnimal = getAssignedAnimal(device.device_id);
            return (
              <div key={device.id} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-[#c0c9c1]/10 group">
                <div className="p-6">
                  <div className={`flex items-start justify-between mb-4 ${isRtl ? 'flex-row-reverse text-right' : ''}`}>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#717973]">{device.name || device.type || '-'}</p>
                      </div>
                    </div>
                        ...
                        {(() => {
                          ...
                          return assignedAnimal ? (
                            <Link
                              ...
                              className={`flex items-center gap-3 hover:bg-[#f4f4ef] rounded-lg p-2 -m-2 transition-colors ${isRtl ? 'flex-row-reverse' : ''}`}
                            >
