...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Stripe keys (from env to avoid hardcoded secrets)
        Setting::updateOrCreate(['key' => 'stripe_public_key'], ['value' => env('STRIPE_KEY', '')]);
        Setting::updateOrCreate(['key' => 'stripe_secret_key'], ['value' => env('STRIPE_SECRET', '')]);
